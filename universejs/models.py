...
class Planet(models.Model):
    ...
    texture_map = models.CharField(max_length=150, null=True, blank=True)
    bump_map = models.CharField(max_length=150, null=True, blank=True)
    specular_map = models.CharField(max_length=150, null=True, blank=True)
